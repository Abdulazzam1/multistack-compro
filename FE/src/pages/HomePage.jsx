      ...
      <div className="container">
        <div className={styles.aboutGrid}>
          ...
          <div className={styles.aboutContent}>
            ...
            <h2 className="section-title">Kepercayaan Dibangun dari <em>Setiap Proyek</em></h2>
            <p className="section-sub">{settings.about_description || 'PT. Multistack Indonesia adalah perusahaan terkemuka dalam penyediaan solusi MEP terpadu. Dengan rekam jejak lebih dari 16 tahun, kami melayani berbagai sektor industri dari Sabang sampai Merauke.'}</p>
            ...
            <Link to="/tentang-kami" className="btn btn-red" style={{ marginTop: '2rem', display: 'inline-flex' }}>Selengkapnya →</Link>
          </div>
        </div>
      </div>
    </section>
