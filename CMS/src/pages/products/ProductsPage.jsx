        ...
        <div className={modal.overlay} onClick={() => setConfirm(null)}>
          <div className={`${modal.modal} ${modal.modalSm}`} onClick={e => e.stopPropagation()}>
            ...
            <div className={modal.body}>
              <p style={{color:'var(--white70)',fontSize:'0.9rem'}}>
              ...
              <table style={{width:'100%'}}>
                <thead style={{background:'var(--bg3)',borderBottom:'1px solid var(--border)'}}>
                  <tr>
                    ...
                    <th className="th" style={{textAlign:'right',width:120}}>Aksi</th>
                  </tr>
                </thead>
                <tbody>
                  {products.length === 0
                    ? <tr><td className="td" colSpan={6} style={{textAlign:'center',padding:'3rem',color:'var(--white70)'}}>
