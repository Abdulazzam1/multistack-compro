      ...
      <div className={styles.inner}>
        ...
        <div className={styles.brand}>
          ...
          <div className={styles.socials}>
            {s.social_instagram && (
              <a href={s.social_instagram} target="_blank" rel="noreferrer" className={styles.socialBtn} aria-label="Instagram">
                <IconIG />
              </a>
            )}
            {s.social_linkedin && (
              <a href={s.social_linkedin} target="_blank" rel="noreferrer" className={styles.socialBtn} aria-label="LinkedIn">
                <IconLI />
              </a>
            )}
            <a href={waUrl} target="_blank" rel="noreferrer" className={styles.socialBtn} aria-label="WhatsApp">
              <IconWA />
            </a>
          </div>
        </div>
